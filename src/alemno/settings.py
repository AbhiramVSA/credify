"""
Django settings for alemno project.
...
SECRET_KEY = 'django-insecure-y509*89uwqk(x_hu+la3sf7e++usm5(cre(%#xz8ee_lt!k7#$'
...
WSGI_APPLICATION = 'alemno.wsgi.application'
